...
public class LegacyScoreboard {
    public org.bukkit.scoreboard.Scoreboard originalScoreboard;
    public Objective objective;
    public String title;
    public LegacyScoreboard(String title) {
        this.title = title;
     ...
     * @return scoreboard
     */
    public static LegacyScoreboard createScoreboard(String title, String... lines) {
     ...
     * @return scoreboard
     */
    public static LegacyScoreboard createScoreboard(String title, List<String> lines) {
        LegacyScoreboard scoreboard = new LegacyScoreboard(title);
